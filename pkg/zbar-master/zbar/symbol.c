...
unsigned char *zbar_symbol_get_payload_after_ecc(const zbar_symbol_t *sym)
{   
    return (sym->payload_after_ecc);
}

unsigned int zbar_symbol_get_payload_after_ecc_length(const zbar_symbol_t *sym)
{
    return (sym->payload_after_ecc_length);
}

unsigned char zbar_symbol_get_version(const zbar_symbol_t *sym)
{   
    return (sym->version);
}
unsigned char zbar_symbol_get_ecc_level(const zbar_symbol_t *sym)
{   
    return (sym->ecc_level);
}
unsigned int zbar_symbol_get_eci(const zbar_symbol_t *sym)
{   
    return (sym->eci);
}
/* #MODIFIED_END_HERE */
