...
def _data_repr(self):
    return (
        f'QRData(payload={self.payload!r}'
        f', payload_no_ecc={self.payload_no_ecc!r}'
        f', payload_after_ecc={self.payload_after_ecc!r}'
...
def _code_repr(self):
    return f'QRCode(size={self.size}, corners={self.corners!r})'
